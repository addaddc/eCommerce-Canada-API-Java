...
public class TestTrack2PurchaseEfraud
{
...
/*********************** Transaction Object *******************************/
        ...
        Track2Purchase swipedPurchase
        		= new Track2Purchase (order_id, cust_id, amount, track2,
        							   pan, expdate, pos_code);
		swipedPurchase.setAvsInfo (avs);
		swipedPurchase.setCvdInfo (cvd);
