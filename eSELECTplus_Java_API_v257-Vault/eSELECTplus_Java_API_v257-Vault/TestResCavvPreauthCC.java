...
public class TestResCavvPreauthCC
{
...
/************************ Request Object ******************************/
	    ...
	    ResCavvPreauthCC resCavvPreauthCC = new ResCavvPreauthCC(data_key, order_id, amount, cavv);
        
	    resCavvPreauthCC.setCustId(cust_id);
	    //resPurchaseCC.setExpdate(expdate);
	    resCavvPreauthCC.setDynamicDescriptor(dynamic_descriptor);
	   	    
	    ResolverHttpsPostRequest mpgReq =
            new ResolverHttpsPostRequest(host, store_id, api_token, resCavvPreauthCC);
