...
public class TestResPreAuthCCEfraud
{
...
/************************ Request Object ******************************/
	    ...
	    ResPreauthCC resPreauthCC = new ResPreauthCC(data_key, order_id, amount, crypt_type);
        
	    resPreauthCC.setCustId(cust_id);
	    resPreauthCC.setAvsInfo(avs);
	    resPreauthCC.setCvdInfo(cvd);
